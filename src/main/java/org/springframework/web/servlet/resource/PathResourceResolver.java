...
public class PathResourceResolver extends AbstractResourceResolver {
	...
	protected Resource getResource(String resourcePath, Resource location) throws IOException {
		...
		System.out.println(resource.toString()+":"+resource.exists()+":"+resource.isReadable());
		//System.out.println(resource.getURL()+":"+resource.toString()+":"+resource.exists()+":"+resource.isReadable());
		logger.info(resource.getURL()+":"+resource.toString()+":"+resource.exists()+":"+resource.isReadable());if (resource.exists() && resource.isReadable()) {
